...
const ParticularTask = ({data}) => {
  ...
  return (
...

    {
        data.map((elem, index)=>{
            return(
                <div className=' relative flex-1 flex flex-col justify-start  h-fit max-lg:min-w-[250px] lg:min-w-[600px] bg-slate-800/60 hover:shadow-2xl hover:shadow-slate-800 hover:scale-[1.01] transition-all ease-in-out cursor-pointer rounded-lg px-6 py-5'>
